    ...
    <div className="relative flex min-h-screen flex-col bg-white text-zinc-900 dark:bg-[#0a0a0a] dark:text-white overflow-hidden">
      ...
      <nav className="sticky top-0 z-20 flex items-center justify-between border-b border-zinc-200 bg-white/80 px-6 py-4 backdrop-blur-md dark:border-zinc-800 dark:bg-[#0a0a0a]/80 md:px-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/analyze"
            className="hidden md:flex rounded-lg bg-blue-600 px-4 py-1.5 text-sm font-semibold text-white transition-all hover:bg-blue-500 hover:shadow-[0_0_20px_rgba(37,99,235,0.4)] dark:bg-cyan-400 dark:text-black dark:hover:bg-cyan-300 dark:hover:shadow-[0_0_20px_rgba(34,211,238,0.3)]"
          >
            Comenzar
          </Link>
        </div>
        ...
        <div className="w-full max-w-2xl">
          <div className="overflow-hidden rounded-xl border border-zinc-200 bg-zinc-50 shadow-2xl shadow-blue-500/10 dark:shadow-cyan-500/5 dark:border-zinc-800 dark:bg-[#111111]">
            ...
            <div className="flex justify-center border-t border-zinc-200 px-5 py-4 dark:border-zinc-800">
              <Link
                href="/analyze"
                className="rounded-lg bg-blue-600 px-6 py-2.5 text-sm font-bold text-white transition-all hover:bg-blue-500 hover:shadow-[0_0_24px_rgba(37,99,235,0.4)] dark:bg-cyan-400 dark:text-black dark:hover:bg-cyan-300 dark:hover:shadow-[0_0_24px_rgba(34,211,238,0.35)]"
              >
                Comenzar ahora
              </Link>
            </div>
